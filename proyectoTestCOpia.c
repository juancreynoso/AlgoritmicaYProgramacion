...
Al probar el archivo nov2022.dat obtenido de EVELIA, el programa y sus funciones trabajaron correctamente,
solo que se mostraron 68 registros. Casualmente ninguno con precipatciones.
El programa fue compilado en sistema operativo Linux.
Se adjunta tambien un archivo (2022.dat), el cual contiene registros con los que se realizaron pruebas.
*/
...
int main() {
    ...
    anio = strtol(arch, NULL, 10); //Funcion que pasa de variable char a int y se almacena para representar el 
...
void SuprRegDiario(FILE* f) {  
    ...
    if (reg.ddmmyyyy == fecha) {    //Al terminar el ciclo verificamos si encontro la fecha solicitada
        ...
        printf("Registro eliminado!");  //Se informa que el registro se elimino con exito 
    } else {
