...
Se adjunta tambien un archivo (archPrueba2020.dat), el cual contiene registros con los que se realizaron pruebas.
...
void Insertar(TNodo* p, RegDiario elem) {
    ...
    a2 = (TNodo*)malloc(sizeof(TNodo)); //Creación de doblete 
    a2->info = elem;    //Asignación asigna al campo info el contenido del registro 
    a2->next = aux->next;   
    aux->next = a2;
}
