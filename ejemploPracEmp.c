...
int main() {
    ...
    while (eleccion != 6) {
        ...
        if (eleccion == 1) {
            insertarApellido(&listaEmp, &empleado[50]);
        } 
        else {
            if(eleccion == 2){
                suprimirApellido(&listaEmp, &empleado[50]);
            }
            else {
                if(eleccion == 3) {
                    modificarEmpleado(&listaEmp, &empleado[50]);
                }
                else {
                    if(eleccion == 4){
                        ...
                        if(eleccion == 5){
                            ...
                            scanf("%s", &empleado[50]); //hasta aca esta bien dea 
                            //ta to gucci 
                            i=0;
                            while (i <= listaEmp.cant) {
                                if (buscarApellido(listaEmp, empleado[50]) == i) {
